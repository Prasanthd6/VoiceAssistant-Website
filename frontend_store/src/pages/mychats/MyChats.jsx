...
const MyChats = () => {
 ...
 if (messagesEndRef.current) {
  ...
  const handleVoiceSendMessage = (e) => {
    ...
    if (targetUser) {
      handleOpenChat(targetUser, msg); // 🧠 Use your defined chat opening logic


      //   window.pendingAutoVoiceMessage = msg; // ✅ Store temporarily
      // setTimeout(() => {
      //   // Trigger message send after chat is opened
      //   window.dispatchEvent(
      //     new CustomEvent("auto-chat-message", { detail: msg })
      //   );
      // }, 200);
    } else {
