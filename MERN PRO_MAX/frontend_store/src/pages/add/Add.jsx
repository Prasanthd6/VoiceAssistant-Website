...
//   // If not a seller and on /add page, redirect to home or show warning
//   if (location.pathname === "/add" && !currentUser?.isSeller) {
//     alert("Only sellers can access the add gig page.");
//     // navigate("/");
//   }
// }, [location.pathname]);
